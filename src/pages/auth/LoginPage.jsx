  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.accessToken) {
        ...
        const tokenPayload = JSON.parse(atob(data.accessToken.split(".")[1])); // decode JWT payload
        const loggedInUser = {
        ...
        setUser({ ...loggedInUser, token: data.accessToken }); // context
        localStorage.setItem(
          "user",
          JSON.stringify({ ...loggedInUser, token: data.accessToken }),
