      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 rounded-xl overflow-hidden shadow-lg transform hover:scale-[1.02] transition duration-300">
            <img 
              src="https://i.pinimg.com/1200x/8d/0b/c6/8d0bc6db157424e5ce0e5dddce3ad0d7.jpg" 
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index} 
                className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border-l-4 border-red-600"
              >
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-red-600 to-red-500 rounded-xl p-12 text-center">
          ...
          <div className="max-w-md mx-auto flex flex-col text-white sm:flex-row gap-4">
            <input 
              type="email" 
              placeholder="rinshadcontacts@gmail.com" 
              className="flex-grow px-4 py-3 rounded-lg focus:outline-none"
            />
            <button className="bg-white text-red-500 px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition shadow-md">
              Join Now
            </button>
          </div>
